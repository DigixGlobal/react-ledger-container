...
var _u2fApi = require('ledgerco/browser/u2f-api');
...
var LedgerContianer = function (_Component) {
  ...
  _createClass(LedgerContianer, [{
    ...
    value: function initLedger() {
      ...
      return new Promise(function (resolve, reject) {
        if (_this3.ethLedger) {
          resolve(_this3.ethLedger);return;
        }
        _ledgerco2.default.comm_u2f.create_async().then(function (comm) {
          comm.timeoutSeconds = _constants.TIMEOUT_DEFAULT;
          _this3.ethLedger = new _ledgerco2.default.eth(comm);
          _this3.ethLedger.getAppConfiguration_async().then(function (config) {
...
LedgerContianer.propTypes = {
  renderReady: _react.PropTypes.func.isRequired,
  renderLoading: _react.PropTypes.func,
  renderError: _react.PropTypes.func,
  onReady: _react.PropTypes.func,
  expect: _react.PropTypes.shape({
    kdPath: _react.PropTypes.string,
