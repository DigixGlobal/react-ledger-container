...
function signTransaction(_ref) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    ethLedger.signTransaction(kdPath, rawHash).then(function (result) {
...
function signMessage(_ref3) {
  ...
  return new Promise(function (resolve, reject) {
    ethLedger.signPersonalMessage(kdPath, Buffer.from(txData).toString('hex')).then(function (result) {
      var v = result.v - 27;
      v = v.toString(16);
      if (v.length < 2) {
        v = '0' + v;
